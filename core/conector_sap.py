...
import datetime
import pandas as pd
from core.configuracion import CSV_PATH, AUDIT_LOG_PATH
...
# Datos de referencia del Landscape SAP (S/4HANA, HANA DB, SolMan, Web Dispatcher)
DATA_LANDSCAPE_SAP_DEFAULT = [
    {
        "servidor_id": "SRV-SAP-HANA01",
        "numero_serie": "HPE-DL580-SN901",
        "ip": "10.24.10.50",
        "sid": "HDB",
        "instancia": "HDB00",
        "vcloud_vm": "vm-sap-hana-pri",
        "nivel_arquitectura": "L3 - Middleware",
        "componente": "SAP HANA DB 2.0 SPS07 (Primary HSR)",
        "os": "SUSE Linux Enterprise Server 15 SP4",
        "cpu_pct": 34.2,
        "mem_pct": 82.5,
        "disco_pct": 58.0,
        "kernel": "HANA 2.00.070.00",
        "estado": "Operativo",
        "sap_host_agent": "7.22 PL 62",
        "nagios_check": "OK (HSR in sync)"
    },
    {
        "servidor_id": "SRV-SAP-HANA02",
        "numero_serie": "HPE-DL580-SN902",
        "ip": "10.24.10.51",
        "sid": "HDB",
        "instancia": "HDB00",
        "vcloud_vm": "vm-sap-hana-sec",
        "nivel_arquitectura": "L3 - Middleware",
        "componente": "SAP HANA DB 2.0 SPS07 (Secondary HSR)",
        "os": "SUSE Linux Enterprise Server 15 SP4",
        "cpu_pct": 18.0,
        "mem_pct": 81.9,
        "disco_pct": 57.5,
        ...
        "estado": "Operativo",
        "sap_host_agent": "7.22 PL 62",
        "nagios_check": "OK (Replication Active)"
    },
    {
        "servidor_id": "SRV-SAP-PRDASCS",
        "numero_serie": "HPE-BL460-SN910",
        "ip": "10.24.10.60",
        "sid": "PRD",
        "instancia": "ASCS01",
        "vcloud_vm": "vm-sap-prd-ascs",
        "nivel_arquitectura": "L4 - Aplicación",
        "componente": "SAP S/4HANA 2022 Central Services (ASCS/ERS)",
        ...
        "estado": "Operativo",
        "sap_host_agent": "7.22 PL 62",
        "nagios_check": "OK (Enqueue Service Online)"
    },
    {
        "servidor_id": "SRV-SAP-PRDPAS",
        "numero_serie": "HPE-BL460-SN911",
        "ip": "10.24.10.61",
        "sid": "PRD",
        "instancia": "PAS02",
        "vcloud_vm": "vm-sap-prd-pas",
        "nivel_arquitectura": "L4 - Aplicación",
        "componente": "SAP S/4HANA Primary Application Server (PAS)",
        "os": "Red Hat Enterprise Linux 8.8",
        "cpu_pct": 68.2,
        "mem_pct": 74.6,
        "disco_pct": 45.0,
        ...
        "estado": "Operativo",
        "sap_host_agent": "7.22 PL 62",
        "nagios_check": "OK (Dialog Queues Normal)"
    },
    {
        "servidor_id": "SRV-SAP-PRDAAS01",
        "numero_serie": "HPE-BL460-SN912",
        "ip": "10.24.10.62",
        "sid": "PRD",
        "instancia": "AAS03",
        "vcloud_vm": "vm-sap-prd-aas01",
        "nivel_arquitectura": "L4 - Aplicación",
        "componente": "SAP S/4HANA Additional Application Server (AAS)",
        "os": "Red Hat Enterprise Linux 8.8",
        "cpu_pct": 52.8,
        "mem_pct": 69.1,
        "disco_pct": 43.8,
    ...
    {
        "servidor_id": "SRV-SAP-WDISP01",
        "numero_serie": "HPE-BL460-SN920",
        "ip": "10.24.10.40",
        "sid": "WDP",
        "instancia": "WDP00",
        "vcloud_vm": "vm-sap-wdisp01",
        "nivel_arquitectura": "L3 - Middleware",
        "componente": "SAP Web Dispatcher (Load Balancer HTTPS)",
        "os": "Red Hat Enterprise Linux 8.8",
        "cpu_pct": 22.0,
        "mem_pct": 35.5,
        "disco_pct": 25.0,
        ...
        "estado": "Operativo",
        "sap_host_agent": "7.22 PL 62",
        "nagios_check": "OK (SSL Terminated, Round Robin)"
    },
    {
        "servidor_id": "SRV-SAP-SOLMAN",
        "numero_serie": "HPE-DL380-SN930",
        "ip": "10.24.10.90",
        "sid": "SM1",
        "instancia": "SOL01",
        "vcloud_vm": "vm-sap-solman",
        "nivel_arquitectura": "L3 - Middleware",
        "componente": "SAP Solution Manager 7.2 / LMDB",
        ...
        "kernel": "753 PL 1100",
        "estado": "En Revision",
        "sap_host_agent": "7.22 PL 60",
        "nagios_check": "WARNING (High Memory Usage 89%)"
    }
]

ALERTAS_SAP_DEFAULT = [
    {
        "id_alerta": "ALT-SAP-8902",
        "sid": "SM1",
        "servidor_id": "SRV-SAP-SOLMAN",
    ...
    {
        "id_alerta": "ALT-SAP-8901",
        "sid": "HDB",
        "servidor_id": "SRV-SAP-HANA01",
        "tipo": "HSR Replication Lag",
...
def probar_conexion_api_sap(endpoint_url: str, tipo_auth: str, client_id: str = "") -> dict:
    ...
    time.sleep(0.25)
    url_limpia = endpoint_url.strip() if endpoint_url else ""

    return {
        "status_code": 200,
        "status_text": "OK",
        "latencia_ms": max(latencia_ms, 24),
        "endpoint": url_limpia if url_limpia else "API Gateway SAP",
        ...
        "systems": [
            {
                "sid": "HDB",
                "type": "Database",
                "database_product": "SAP HANA DB 2.0 SPS07",
                "high_availability": {
                    "mode": "HSR (HANA System Replication)",
                    "operation_mode": "logreplay",
                    "status": "Active / In-Sync"
                },
                "hosts": [
                    {"hostname": "SRV-SAP-HANA01", "role": "Primary Node", "ip": "10.24.10.50"},
                    {"hostname": "SRV-SAP-HANA02", "role": "Secondary Node", "ip": "10.24.10.51"}
                ]
            },
            {
                "sid": "PRD",
                "type": "ERP S/4HANA",
                "release": "SAP S/4HANA 2022 FPS02",
                "kernel_version": "789 PL 200",
                "instances": [
            ...
            },
            {
                ...
                "release": "SAP Solution Manager 7.2 SPS16",
                "instances": [
                    {"instance_name": "SOL01", "hostname": "SRV-SAP-SOLMAN", "role": "LMDB / CCDB Engine"}
                ]
            }
        ],
...
def generar_topologia_sap_mermaid() -> str:
    ...
    return """graph TD
    %% Estilos corporativos Obsidian & Indigo
...
def sincronizar_servidores_sap_cmdb(autor: str = "Conector API SAP") -> tuple[bool, int, str]:
    ...
    for item in DATA_LANDSCAPE_SAP_DEFAULT:
        srv_id = item["servidor_id"]
        if srv_id not in ids_existentes:
            nuevo_registro = {
                "servidor_id": srv_id,
    ...
    df_consolidado = pd.concat([df_actual, df_nuevos], ignore_index=True)

    try:
        df_consolidado.to_csv(CSV_PATH, index=False, encoding="utf-8")

        # Registrar trazabilidad en el log de auditoria
